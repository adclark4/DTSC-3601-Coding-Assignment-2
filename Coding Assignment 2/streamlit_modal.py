...
def run():
    ...
    if os.getenv("SUPABASE_KEY"):
        env_vars["SUPABASE_KEY"] = os.getenv("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZndmpjbHp5dnZjdG9naWNma3F6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU3MTUwMzAsImV4cCI6MjA3MTI5MTAzMH0.iJNZvVcEUY9A_hkl5LelWK2nQQomgw9GgAB8qt5Jawk")
    if os.getenv("SUPABASE_URL"):
        env_vars["SUPABASE_URL"] = os.getenv("https://vgvjclzyvvctogicfkqz.supabase.co")
